# -*- coding: utf-8 -*-
#
# Eskapade-Spark documentation build configuration file for sphinx.
#
#

import os, sys

#from eskapadespark import version as esversion
...
exclude_patterns = ['*test*', 'eskapadespark.tutorials.*']
...
htmlhelp_basename = 'EskapadeSparkdoc'
...
latex_documents = [
    (master_doc, 'EskapadeSpark.tex', 'Eskapade-Spark Documentation',
...
man_pages = [
    (master_doc, 'eskapadespark', 'Eskapade-Spark Documentation',
     [author], 1)
]
